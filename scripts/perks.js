...
window.PERKS = [
  ...
  },
  {
    "id": "blood-drinker",
    "name": "Blood Drinker",
    "description": "When you score a Critical Success with an attack that deals slashing damage to a creature, gain temporary hit points equal to the damage you deal with the attack for 1 minute",
  ...
  {"id":"lycan-curse","name":"Lycan Curse","description":"Decrease your Intelligence or Charisma score by 1. If this perk is removed, you lose the benefits of perks that require it. The DM can introduce unforeseen circumstances around full moons. You can select perks that require Lycan Curse only when you gain a level.","requirements":"No other curse perks, DM's permission"},
  ...
  {"id":"rotting-curse","name":"Rotting Curse","description":"Decrease your Strength or Constitution score by 1. If this perk is removed, you lose the benefits of perks that require it. You gain resistance to necrotic and poison damage. You can select perks that require Rotting Curse only when you gain a level.","requirements":"No other curse perks, DM's permission"},
  ...
  {"id":"mana-curse","name":"Mana Curse","description":"Decrease your Constitution, Wisdom, or Charisma score by 1. You gain blindsight out to 10 feet while conscious; within that range, you perceive each creature's shape but not specific details or color, and attackers cannot gain advantage on melee attacks against you because of flanking or being hidden. This sense functions while blinded. If this perk is removed, you lose the benefits of perks that require it. You can select perks that require Mana Curse only when you gain a level.","requirements":"No other curse perks, DM's permission, Spellcasting or Pact Magic feature"},
  ...
  {"id":"minify","name":"Minify","description":"Increase your Dexterity score by 2, to a maximum of 20, and decrease your Strength score by 1. Your speed decreases by 5 feet and your size becomes Tiny. See the size rules for equipment and carrying capacity.","requirements":"Be one of the following races: Changeling, Gnome, Grung, Lizardfolk, Warforged, Harengon, Locathah, does not have Magnify"},
